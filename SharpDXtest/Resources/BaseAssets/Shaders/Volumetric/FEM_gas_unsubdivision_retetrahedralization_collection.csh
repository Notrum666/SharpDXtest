...
RWStructuredBuffer<int> octreeUnsubdivisionList : register(u1);
RWStructuredBuffer<int> toRetetrahedralizeList : register(u2);
...
void main(uint3 groupID : SV_GroupID, uint groupIndex : SV_GroupIndex)
{
    ...
    octreeUnsubdivisionList[index] = -1;
    ...
    toRetetrahedralizeList[curOctantIndex] = 1;
